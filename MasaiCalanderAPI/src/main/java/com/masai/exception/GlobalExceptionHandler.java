...
public class GlobalExceptionHandler {
	 ...
	 public ResponseEntity<ErrorDetails> userExceptionHandler(UserException ce, WebRequest req) {
	 ...
	 public ResponseEntity<ErrorDetails> blogExceptionHandler(EventException ae, WebRequest req) {
	  ErrorDetails err = new ErrorDetails();
